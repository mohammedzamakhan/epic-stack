        ...
        },
        {
            ...
            defaultValue: [
                ...
                },
                {
                    ...
                    description: 'Provident fugit and vero voluptate. magnam magni doloribus dolores voluptates a sapiente nisi.',
                    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5.5 7c2 0 6.5-3 6.5-3s4.5 3 6.5 3v4.5C18.5 18 12 20 12 20s-6.5-2-6.5-8.5z"/></svg>`,
                    variant: 'icon',
                    colSpan: '2',
                },
                {
                    title: 'Faster than light',
                    description: 'Provident fugit vero voluptate. magnam magni doloribus dolores voluptates inventore nisi.',
                    variant: 'chart',
                    colSpan: '2',
                },
                {
            ...
            fields: [
                ...
                },
                {
                    name: 'value',
                    type: 'text',
                    label: 'Stat Value (e.g., 100%, 24/7)',
                    admin: {
                        description: 'Optional large value to display (like 100%)',
                    },
                },
                {
                    name: 'description',
                ...
                },
                {
                    ...
                    admin: {
                        language: 'html',
                        description: 'SVG icon code for icon, default, and dashboard variants',
                        condition: (data, siblingData) => siblingData?.variant === 'icon' || siblingData?.variant === 'default' || siblingData?.variant === 'dashboard',
                    },
                },
                {
                    name: 'chartSvg',
                    ...
                    admin: {
                        language: 'html',
                        description: 'SVG chart code for chart and dashboard variants',
                        condition: (data, siblingData) => siblingData?.variant === 'chart' || siblingData?.variant === 'dashboard',
                    },
                },
                {
                    name: 'avatars',
                    ...
                    maxRows: 5,
                    admin: {
                        condition: (data, siblingData) => siblingData?.variant === 'chat',
                    },
                    fields: [
                        {
                            name: 'name',
