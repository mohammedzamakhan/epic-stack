...
<Warning>
	Never reduce the bcrypt cost factor below 10. The default of 12 is recommended
	by OWASP.
</Warning>
...
<AccordionGroup>
	<Accordion title="Enable MFA for All Users">
		Encourage or require all users to enable two-factor authentication. Consider
		making it mandatory for admin accounts.
	</Accordion>
	<Accordion title="Use Passkeys When Possible">
		Passkeys provide the strongest protection against phishing and credential
		theft.
	</Accordion>
	...
	<Accordion title="Regular Session Audit">
		Encourage users to review their active sessions and revoke any they don't
		recognize.
	</Accordion>
</AccordionGroup>
