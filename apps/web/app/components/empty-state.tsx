...
export function EmptyState({
	...
	return (
		...
		>
			<div className="bg-background shadow-sm ring-1 ring-border dark:bg-muted/50 hover:dark:bg-muted/70 group rounded-xl p-14 transition duration-500 hover:duration-200">
