		...
		<ThreadPrimitive.Empty>
			<div className="flex w-full max-w-[var(--thread-max-width)] flex-grow flex-col">
				<div className="flex w-full flex-grow flex-col items-center justify-center">
					<p className="mt-4 font-medium">Learn more about this note!</p>
				</div>
	...
	return (
		<div className="mt-3 flex w-full items-stretch justify-center gap-4">
			<ThreadPrimitive.Suggestion
				...
				prompt="Tell me more about this note."
				method="replace"
				autoSend
			>
			...
			<ThreadPrimitive.Suggestion
				className="hover:bg-muted/80 flex max-w-sm grow basis-0 flex-col items-center justify-center rounded-lg border p-3 transition-colors ease-in"
				prompt="When is this note supposed to expire?"
				method="replace"
				autoSend
			>
				<span className="line-clamp-2 text-sm font-semibold text-ellipsis">
					When is this note supposed to expire?
				</span>
			</ThreadPrimitive.Suggestion>
		</div>
	)
