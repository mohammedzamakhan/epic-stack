import { getFieldsetProps, getInputProps, useForm, type FieldMetadata } from '@conform-to/react'
...
function ImagePreview({
    ...
    return (
        <fieldset {...getFieldsetProps(meta)} className="relative group aspect-square">
