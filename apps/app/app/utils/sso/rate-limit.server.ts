...
export const ssoAuthInitiateRateLimit = onWorker
	? noopRateLimit
	: rateLimit({
			...baseRateLimit,
...
export const ssoCallbackRateLimit = onWorker
	? noopRateLimit
	: rateLimit({
			...baseRateLimit,
...
export const ssoConfigChangeRateLimit = onWorker
	? noopRateLimit
	: rateLimit({
			...baseRateLimit,
