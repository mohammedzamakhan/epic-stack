		...
		<Card className="mx-auto w-full max-w-md bg-white/95 backdrop-blur">
				...
				<div>
					...
					<div className="grid grid-cols-2 gap-4">
						<div className="text-center">
							<p className="text-muted-foreground mb-1 text-xs"><Trans>Your points</Trans></p>
							<p className="text-3xl font-bold">{waitlistEntry.points}</p>
						</div>
						<div className="text-center">
							<p className="text-muted-foreground mb-1 text-xs"><Trans>Your rank</Trans></p>
							<p className="text-3xl font-bold">#{rank}</p>
							<p className="text-muted-foreground text-xs">
								<Trans>of</Trans> {totalUsers} <Trans>people</Trans>
							</p>
						</div>
					</div>
				</div>
				...
				<div className="space-y-3">
					<div className="flex items-start gap-3">
						...
						<div className="min-w-0 flex-1">
							<div className="my-2 flex items-baseline justify-between gap-2">
								<p className="text-sm font-medium"><Trans>Share with others</Trans></p>
							...
							{waitlistEntry.referralCount > 0 && (
								<p className="mt-2 text-xs text-green-600">
									...
									{waitlistEntry.referralCount === 1 ? t`person` : t`people`}{' '}
									<Trans>joined using your link! Thanks for referring.</Trans>
								</p>
							)}
						</div>
					</div>
					...
					<div className="flex items-start gap-3">
						...
						<div className="flex-1">
							<div className="my-2 flex items-baseline justify-between gap-2">
								<p className="text-sm font-medium"><Trans>Join our Discord</Trans></p>
								<span className="text-xs font-semibold text-green-600">
								...
								<div className="flex flex-col gap-2">
									...
									{hasDiscordOAuth ? (
										<>
											...
											<p className="text-muted-foreground text-xs">
												<Trans>Click "Verify Discord membership" after joining to claim your points automatically.</Trans>
											</p>
										</>
									) : (
										<p className="text-muted-foreground text-xs">
											<Trans>Note: Discord verification is currently manual. Contact support after joining to claim your points.</Trans>
										</p>
									)}
								</div>
							)}
			...
			<CardFooter>
				<p className="text-muted-foreground text-sm">
					<Trans>We'll send you an email at</Trans>{' '}
					<span className="font-semibold">{user.email}</span> <Trans>when we're ready to welcome you.</Trans>
				</p>
			</CardFooter>
		</Card>
	)
