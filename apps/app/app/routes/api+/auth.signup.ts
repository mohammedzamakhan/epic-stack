    ...
    try {
        ...
        return data({
            ...
            data: {
                ...
                // For security, never expose OTP in API responses by default.
                // If needed for automated testing in dev/test environments,
                // use the EXPOSE_OTP_IN_RESPONSE feature flag for explicit opt-in.
                ...(process.env.EXPOSE_OTP_IN_RESPONSE === 'true' && { otp }),
            },
        })
    } catch (error) {
