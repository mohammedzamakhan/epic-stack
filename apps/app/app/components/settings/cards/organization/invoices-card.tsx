            ...
            <CardContent>
                {invoices.length === 0 ? (
                    <div className="py-8 text-center">
                        <Icon name="file-text" className="mx-auto h-12 w-12 text-muted-foreground" />
                                    ...
                                    <div className="flex gap-2">
                                        {invoice.hostedInvoiceUrl && (
                                            <Button variant="outline" size="sm" asChild>
                                                <Link to={invoice.hostedInvoiceUrl} target="_blank" rel="noopener noreferrer">
                                        ...
                                        {invoice.invoicePdf && (
                                            <Button variant="outline" size="sm" asChild>
                                                <Link to={invoice.invoicePdf} target="_blank" rel="noopener noreferrer">
