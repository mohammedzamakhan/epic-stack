...
test.describe('Organization Management', () => {
	test('Users can create a new organization', async ({ page, login, navigate }) => {
	...
	test('Users can switch between organizations', async ({ page, login, navigate }) => {
		const user = await login()
	...
	test('Users can view organization settings', async ({ page, login, navigate }) => {
		const user = await login()
	...
	test('Users can update organization details', async ({ page, login, navigate }) => {
		const user = await login()
	...
	test('Users can view organization members', async ({ page, login, navigate }) => {
		const user = await login()
	...
	test('Organization owners can remove members', async ({ page, login, navigate }) => {
		const user = await login()
