...
import { triggerSuccessHaptic, triggerErrorHaptic } from '../../lib/haptics/haptic-utils'
...
export default function OnboardingScreen() {
  ...
  const onSubmit = async (data: OnboardingFormData) => {
    try {
      ...
      await onboarding({
        ...
        agreeToTermsOfServiceAndPrivacyPolicy: data.agreeToTermsOfServiceAndPrivacyPolicy,
  ...
  return (
    <Screen>
          ...
          <Card style={styles.card}>
            ...
            <CardContent>
              <View style={styles.formContainer}>
                ...
                {error && (
                  <ErrorText style={styles.formError}>
                    {error}
                  </ErrorText>
                )}
      ...
      {isLoading && <LoadingOverlay visible={isLoading} message="Creating account..." />}
      {showSuccess && <SuccessAnimation visible={showSuccess} message="Account created!" />}
    </Screen>
  )
}
