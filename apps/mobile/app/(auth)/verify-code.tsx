...
export default function VerifyCodeScreen() {
  const { email, type = 'onboarding', redirectTo } = useLocalSearchParams<{
    email?: string
    type?: string
    redirectTo?: string
  }>()
  ...
  return (
    <Screen>
                    ...
                    <View style={styles.otpContainer}>
                      ...
                      <TextInput
                        ...
                        onChangeText={(text) => {
                          ...
                          const code = text.replace(/[^A-Za-z0-9]/g, '').slice(0, 6).toUpperCase()
      ...
      {isLoading && <LoadingOverlay visible={isLoading} message="Verifying code..." />}
    </Screen>
  )
}
