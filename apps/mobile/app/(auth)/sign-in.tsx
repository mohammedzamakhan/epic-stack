...
export default function SignInScreen() {
  ...
  const { login, isLoading: isLoginLoading, error: loginError, clearError } = useLogin()
  ...
  const onSubmit = async (data: LoginFormData) => {
    try {
      console.log('🔐 Attempting login with:', { username: data.username, remember: data.remember })
              ...
              {isBanned && (
                <View style={styles.bannedContainer}>
                  ...
                  <TouchableOpacity 
                    ...
                    onPress={() => Alert.alert('Contact Support', 'Please email support@example.com for assistance.')}
                  >
