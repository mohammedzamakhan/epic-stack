...
import { Screen, Card, CardHeader, CardContent, Button } from '../../components/ui'
import { useAuth } from '../../lib/auth/hooks/use-auth'
import { useOrganizations } from '../../lib/api/hooks/use-organizations'

export default function DashboardScreen() {
  const { user, logout, isLoading } = useAuth()
  const { organizations, isLoading: organizationsLoading, error: organizationsError } = useOrganizations()
                ...
                <View>
                  {organizations && organizations.map((org, index) => (
                    <View 
                      ...
                      style={[
                        styles.orgRow,
                        index === organizations.length - 1 && styles.lastOrgRow
                      ]}
                    >
                      <View style={styles.orgInfo}>
                        ...
                        <View style={styles.orgMeta}>
                          ...
                          {org.size && (
                            <Text style={styles.orgMetaText}> • {org.size}</Text>
                          )}
                        </View>
                      </View>
                    </View>
          ...
          <Card style={styles.card}>
            ...
            <CardContent>
              <Text style={styles.appDescription}>
                You're successfully logged into the Epic Stack mobile app! 
                This is a React Native app built with Expo Router and integrated 
                with the Epic Stack backend.
              </Text>
