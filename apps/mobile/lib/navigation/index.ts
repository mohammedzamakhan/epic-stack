...
export const handleDeepLink = (url: string): void => {
  try {
    ...
    console.log('Parsed deep link:', { pathname, params: Object.fromEntries(searchParams) })
...
export const navigateAfterAuth = (redirectTo?: string): void => {
  console.log('🧭 Navigation: navigateAfterAuth called with redirectTo:', redirectTo)
