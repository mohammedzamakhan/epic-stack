...
export class JWTAuthApi {
  ...
  private async handleTokenRefresh(
    ...
    const response = await fetch(`${this.httpClient.getConfig().baseUrl}${this.endpoints.refresh}`, {
      method: 'POST',
      headers: {
  ...
  async login(credentials: LoginRequest): Promise<JWTLoginApiResponse> {
    try {
      const response = await this.httpClient.postForm<JWTLoginApiResponse['data']>(
  ...
  async signup(signupData: SignupRequest): Promise<SignupApiResponse> {
    try {
      const response = await this.httpClient.postForm<SignupApiResponse['data']>(
  ...
  async verify(verifyData: VerifyRequest): Promise<VerifyApiResponse> {
    try {
      const response = await this.httpClient.postForm<VerifyApiResponse['data']>(
   ...
   */
  async onboarding(onboardingData: OnboardingRequest): Promise<JWTOnboardingApiResponse> {
    try {
      const response = await this.httpClient.postForm<JWTOnboardingApiResponse['data']>(
        this.endpoints.onboarding,
        onboardingData
      )
   ...
   */
  async socialAuth(provider: string, redirectTo?: string): Promise<SocialAuthApiResponse> {
    try {
      ...
      const response = await this.httpClient.post<SocialAuthApiResponse['data']>(
        this.endpoints.socialAuth(provider),
        requestData
      )
  ...
  async socialCallback(
    ...
    try {
      ...
      const response = await this.httpClient.get<JWTOAuthCallbackApiResponse['data']>(callbackUrl)
   ...
   */
  async refreshTokens(refreshToken: string, userId: string): Promise<JWTRefreshApiResponse> {
    try {
      const response = await this.httpClient.post<JWTRefreshApiResponse['data']>(
   ...
   */
  async getOrganizations(): Promise<OrganizationsApiResponse | OrganizationsApiError> {
    try {
      const response = await this.httpClient.get<OrganizationsApiResponse['data']>(
