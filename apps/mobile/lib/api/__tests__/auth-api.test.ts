...
describe('AuthApi', () => {
  ...
  describe('signup', () => {
    it('should make successful signup request', async () => {
      ...
      expect(mockHttpClient.postForm).toHaveBeenCalledWith('/api/auth/signup', signupData)
      expect(result).toEqual({
        success: true,
        data: mockResponse.data,
        status: 200,
  ...
  describe('verify', () => {
    it('should make successful verify request', async () => {
      ...
      expect(mockHttpClient.postForm).toHaveBeenCalledWith('/api/auth/verify', verifyData)
      expect(result).toEqual({
        success: true,
        data: mockResponse.data,
        status: 200,
  ...
  describe('onboarding', () => {
    it('should make successful onboarding request', async () => {
      ...
      expect(mockHttpClient.postForm).toHaveBeenCalledWith('/api/auth/onboarding', onboardingData)
      expect(result).toEqual({
        success: true,
        data: mockResponse.data,
        status: 200,
  ...
  describe('socialCallback', () => {
    it('should handle OAuth callback successfully', async () => {
      ...
      expect(mockHttpClient.post).toHaveBeenCalledWith('/auth/github/callback', {
        code,
        state,
        provider,
      })
  ...
  describe('token management', () => {
    ...
    it('should clear auth token', () => {
      ...
      expect(mockHttpClient.removeDefaultHeader).toHaveBeenCalledWith('Authorization')
    })
  })
