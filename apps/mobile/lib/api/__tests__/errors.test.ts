...
describe('Error Utilities', () => {
  describe('parseApiError', () => {
    ...
    it('should throw error for successful responses', () => {
      ...
      expect(() => parseApiError(response)).toThrow('Cannot parse error from successful response')
    })
  })
  ...
  describe('createAuthError', () => {
    ...
    it('should create validation error with field', () => {
      const error = createAuthError('validation', 'Username is required', 'username')
    ...
    it('should create error with details', () => {
      ...
      const error = createAuthError('validation', 'Invalid format', 'email', details)
