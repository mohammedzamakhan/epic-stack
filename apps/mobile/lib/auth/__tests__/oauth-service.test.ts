import { OAuthService, OAUTH_PROVIDERS, createOAuthService } from '../oauth-service'
...
describe('OAuthService', () => {
  ...
  describe('handleCallback', () => {
    it('should successfully handle callback with code', async () => {
      ...
      const result = await oauthService.handleCallback('epicnotes://auth/callback?code=test-auth-code&state=test-state')
    ...
    it('should handle callback error', async () => {
      ...
      const result = await oauthService.handleCallback('epicnotes://auth/callback?error=access_denied')
    ...
    it('should handle invalid callback', async () => {
      ...
      const result = await oauthService.handleCallback('epicnotes://auth/callback')
