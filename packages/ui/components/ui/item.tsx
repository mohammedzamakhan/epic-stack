...
function ItemDescription({ className, ...props }: React.ComponentProps<'p'>) {
	return (
		<p
			...
			className={cn(
				'text-muted-foreground [&>a:hover]:text-primary line-clamp-2 text-left rtl:text-right text-sm leading-normal font-normal group-data-[size=xs]/item:text-xs [&>a]:underline [&>a]:underline-offset-4',
				className,
			)}
			{...props}
		/>
