...
describe('Error Scenarios Integration Tests', () => {
  ...
  describe('API Error Recovery', () => {
    it('should handle channel retrieval errors with fallback', async () => {
      ...
      const channels = await integrationService.getAvailableChannels('slack-integration-123')
    ...
    it('should handle database connection errors', async () => {
      ...
      vi.mocked(prisma.integration.findUnique).mockRejectedValue(new Error('Database query failed'))
    ...
    it('should handle logging failures gracefully', async () => {
      ...
      vi.mocked(prisma.integrationLog.create).mockRejectedValue(new Error('Logging failed'))
  ...
  describe('Provider Error Handling', () => {
    it('should handle unknown provider errors', async () => {
      await expect(
        integrationService.initiateOAuth('org-123', 'unknown-provider', 'https://example.com/callback')
