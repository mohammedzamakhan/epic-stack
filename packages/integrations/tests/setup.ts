...
beforeAll(() => {
    ...
    process.env.INTEGRATIONS_OAUTH_STATE_SECRET = 'test-oauth-state-secret-32-chars'
    ...
    process.env.GITHUB_INTEGRATION_CLIENT_SECRET = 'test-github-integration-client-secret'
