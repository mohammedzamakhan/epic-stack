...
describe('NotionProvider', () => {
  ...
  describe('Provider Properties', () => {
    it('should have correct provider properties', () => {
      ...
      expect(provider.description).toBe('Connect notes to Notion databases for knowledge management and collaboration')
    })
  })
  ...
  describe('handleCallback', () => {
    ...
    it('should handle OAuth error response', async () => {
      ...
      ).rejects.toThrow('Invalid state: malformed structure')
    })
  })
  ...
  describe('refreshToken', () => {
    it('should throw error for token refresh', async () => {
      ...
      ).rejects.toThrow('Notion does not support token refresh. Users must re-authenticate.')
    })
  })
