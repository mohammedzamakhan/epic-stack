...
describe('GitHubProvider', () => {
  ...
  describe('Provider Properties', () => {
    it('should have correct provider properties', () => {
      ...
      expect(provider.description).toBe('Connect notes to GitHub repositories for issue tracking and project management')
    })
  })
  ...
  describe('handleCallback', () => {
    ...
    it('should handle OAuth error response', async () => {
      ...
      ).rejects.toThrow('GitHub OAuth error: access_denied - User denied access')
    })
  })
  ...
  describe('refreshToken', () => {
    it('should throw error for token refresh', async () => {
      ...
      ).rejects.toThrow('GitHub does not support token refresh. Please re-authenticate.')
    })
  ...
  describe('Error Handling', () => {
    it('should handle missing environment variables', async () => {
      ...
      ).rejects.toThrow('GITHUB_INTEGRATION_CLIENT_ID environment variable is required')
    })
  })
})