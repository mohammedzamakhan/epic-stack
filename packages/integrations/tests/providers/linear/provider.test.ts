...
describe('LinearProvider', () => {
  ...
  describe('Provider Properties', () => {
    it('should have correct provider properties', () => {
      ...
      expect(provider.description).toBe('Connect notes to Linear teams and projects for issue tracking and project management')
    })
  })
  ...
  describe('refreshToken', () => {
    it('should throw error for token refresh', async () => {
      ...
      ).rejects.toThrow('Linear does not support token refresh. Please re-authenticate.')
    })
  })
