...
describe('TrelloProvider', () => {
  ...
  describe('Provider Properties', () => {
    it('should have correct provider properties', () => {
      ...
      expect(provider.description).toBe('Connect notes to Trello boards for task management and project organization')
    })
  })
    ...
    it('should generate correct auth URL', async () => {
      ...
      server.use(
        http.post('https://trello.com/1/OAuthGetRequestToken', () => {
          return new HttpResponse('oauth_token=request-token&oauth_token_secret=request-secret', {
  ...
  describe('handleCallback', () => {
    it('should handle successful OAuth callback', async () => {
      ...
      server.use(
        http.post('https://trello.com/1/OAuthGetAccessToken', () => {
          return new HttpResponse('oauth_token=access-token&oauth_token_secret=access-secret', {
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
          })
        })
      )
    ...
    it('should handle OAuth error response', async () => {
      ...
      ).rejects.toThrow('OAuth verifier is required')
    })
  })
  ...
  describe('getAvailableChannels', () => {
    ...
    it('should handle API errors when fetching channels', async () => {
      ...
      ).rejects.toThrow('Failed to get Trello channels: No access token available for Trello integration')
    })
  })
  ...
  describe('postMessage', () => {
    ...
    it('should handle card creation errors', async () => {
      ...
      ).rejects.toThrow('Failed to post message to Trello: No access token available for Trello integration')
    })
  })
