...
import { initializeProviders, getAvailableProviders } from '../../src/providers/index'
...
describe('Providers Index', () => {
  ...
  describe('getAvailableProviders', () => {
    ...
    it('should include Slack provider with correct details', () => {
      ...
      expect(slackProvider?.description).toBe('Connect notes to Slack channels for team collaboration')
    ...
    it('should include Jira provider with correct details', () => {
      ...
      expect(jiraProvider?.description).toBe('Connect notes to Jira projects for issue tracking and project management')
    ...
    it('should include Linear provider with correct details', () => {
      ...
      expect(linearProvider?.description).toBe('Connect notes to Linear teams and projects for issue tracking and project management')
    ...
    it('should include GitLab provider with correct details', () => {
      ...
      expect(gitlabProvider?.description).toBe('Connect notes to GitLab projects for issue tracking and project management')
    ...
    it('should include ClickUp provider with correct details', () => {
      ...
      expect(clickupProvider?.description).toBe('Connect notes to ClickUp spaces and lists for task management')
    ...
    it('should include Notion provider with correct details', () => {
      ...
      expect(notionProvider?.description).toBe('Connect notes to Notion databases for knowledge management and collaboration')
    ...
    it('should include Asana provider with correct details', () => {
      ...
      expect(asanaProvider?.description).toBe('Connect notes to Asana projects for task management and team collaboration')
    ...
    it('should include Trello provider with correct details', () => {
      ...
      expect(trelloProvider?.description).toBe('Connect notes to Trello boards for task management and project organization')
    ...
    it('should include GitHub provider with correct details', () => {
      ...
      expect(githubProvider?.description).toBe('Connect notes to GitHub repositories for issue tracking and project management')
    ...
    it('should return providers in consistent order', () => {
      ...
      expect(providers1.map(p => p.name)).toEqual(providers2.map(p => p.name))
    })
