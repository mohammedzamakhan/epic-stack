...
describe('Type Definitions', () => {
    ...
    describe('Channel', () => {
        ...
        it('should accept all channel types', () => {
            ...
            const privateChannel: Channel = { id: '2', name: 'private', type: 'private' }
    ...
    describe('Integration Types', () => {
        ...
        it('should accept all provider types', () => {
            const productivity: import('../../src/types').ProviderType = 'productivity'
            const ticketing: import('../../src/types').ProviderType = 'ticketing'
            const communication: import('../../src/types').ProviderType = 'communication'
