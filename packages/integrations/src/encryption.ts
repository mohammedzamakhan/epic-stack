...
export class IntegrationEncryptionService {
	...
	async encryptTokenData(tokenData: TokenData): Promise<EncryptedTokenData> {
		...
		const encryptedAccessToken = await this.encryptString(
		...
		if (tokenData.refreshToken) {
			encryptedRefreshToken = await this.encryptString(
	...
	async decryptTokenData(
		...
		const accessToken = await this.decryptString(
		...
		if (encryptedData.encryptedRefreshToken) {
			refreshToken = await this.decryptString(
